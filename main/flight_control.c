...
static void drogue_check(float vertical_vel, float current_alt, float apogee, uint32_t current_time) {
    ...
    // Checks if vertical velocity is less than Drogue activation threshold
    if (vertical_vel < DROGUE_THRESHOLD_VEL) {
